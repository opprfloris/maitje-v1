        ...
        <CardContent>
          {promptVersions.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              <p>Nog geen prompt versies gevonden. Maak je eerste prompt aan in de Editor tab.</p>
            </div>
          ) : (
        ...
        <Card className="bg-blue-50">
          <CardContent className="pt-6">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• Gebruik beschrijvende namen voor je versies (bijv. "Verbeterde tijdsschattingen v2.1")</li>
              <li>• Test nieuwe versies altijd in de Test Sandbox voordat je ze activeert</li>
              <li>• Bewaar werkende versies als backup voordat je grote wijzigingen maakt</li>
              <li>• Gebruik de Feedback Analyse om data-gedreven verbeteringen te maken</li>
            </ul>
          </CardContent>
        </Card>
      )}
